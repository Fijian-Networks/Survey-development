...
if (JSON.parse(control.getPlatformInfo()).container === 'Chrome') {
    ...
    $.ajax({
        url: control.getFileAsUrl('output/debug/household_cooperation_measures_data.json'),
        async: false,  // do it first
        success: function(dataObj) {
            if (dataObj === undefined || dataObj === null) {
                console.log('Could not load data json for table: household_cooperation_measures');
            }
