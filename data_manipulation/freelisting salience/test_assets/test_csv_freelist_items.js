...
const csvStream= format ({ headers: ['_id', 'location', 'gender', 'age', 'item_01','item_02','item_03','item_04','item_05','item_06','item_07','item_08','item_09','item_10', '_form_id','_locale','_savepoint_type','_savepoint_timestamp','_savepoint_creator','_deleted','_data_etag_at_modification','id','_default_access','_group_modify','_group_privileged','_group_read_only','_row_etag','_row_owner']})
...
const generateAge = function() {
  return getRandomInt(70) + 16;
}
...
//choose gender
    line.push(chooseGender(getRandomInt(genders.length)));
    // generate generate
    line.push(generateAge());
...
// write to csv, set i to be number of 'participants'
for(let i = 0; i< 40; i++){
